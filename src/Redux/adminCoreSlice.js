...
const initialState = {
  ...
  productReviewsData: {},
  productReviewSummariesData: {},
  productReviewSummaryReviewsData: {},
...
export const getProductReviews = createApiThunkPrivate("adminCore/getProductReviews", (payload = {}) => payload.sellerScope ? ENDPOINTS.platform.sellerProductReviews : ENDPOINTS.platform.productReviews, "GET", true, { transformParams: pickQuery(["page", "limit", "q", "keyWord", "search", "sellerId", "productId", "buyerId", "orderId", "status", "rating", "sortBy", "sortDir", "sortOrder"]) });
export const getProductReviewSummaries = createApiThunkPrivate("adminCore/getProductReviewSummaries", (payload = {}) => payload.sellerScope ? ENDPOINTS.platform.productReviewSummaries : ENDPOINTS.platform.productReviewSummaries, "GET", true, { transformParams: pickQuery(["page", "limit", "q", "search", "keyWord", "sellerId", "productId", "status", "rating", "sortBy", "sortDir", "sortOrder"]) });
export const getProductReviewSummaryReviews = createApiThunkPrivate("adminCore/getProductReviewSummaryReviews", (payload = {}) => ENDPOINTS.platform.productReviewSummaryReviews(payload.productId || payload.id || payload._id), "GET", true, { transformParams: pickQuery(["page", "limit", "q", "search", "sellerId", "status", "rating", "sortBy", "sortDir", "sortOrder"]) });
...
const adminCoreSlice = createSlice({
  ...
  extraReducers: (builder) => {
    [
      ...
      [getProductReviewSummaries, "productReviewSummariesData"],
      [getProductReviewSummaryReviews, "productReviewSummaryReviewsData"],
