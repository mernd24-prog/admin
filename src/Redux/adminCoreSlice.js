...
export const getProductReviewSummaries = createApiThunkPrivate("adminCore/getProductReviewSummaries", (payload = {}) => payload.sellerScope ? ENDPOINTS.platform.productReviewSummaries : ENDPOINTS.platform.productReviewSummaries, "GET", true, { transformParams: pickQuery(["page", "limit", "q", "search", "keyWord", "productId", "status", "rating", "sortBy", "sortDir", "sortOrder"]) });
export const getProductReviewSummaryReviews = createApiThunkPrivate("adminCore/getProductReviewSummaryReviews", (payload = {}) => ENDPOINTS.platform.productReviewSummaryReviews(payload.productId || payload.id || payload._id), "GET", true, { transformParams: pickQuery(["page", "limit", "q", "search", "status", "rating", "sortBy", "sortDir", "sortOrder"]) });
