...
export const ENDPOINTS = {
  ...
  payouts: {
    ...
    myPayoutPreference: "/sellers/commissions/my-payout-preference",
  ...
  referral: {
    ...
    bonusRules: "/admin/referral/bonus-rules",
    bonusRule: (ruleId) => `/admin/referral/bonus-rules/${ruleId}`,
    evaluateBonusRules: "/admin/referral/bonus-rules/evaluate",
    bonusAchievements: "/admin/referral/bonus-achievements",
    bonusProgress: "/admin/referral/reports/bonus-progress",
