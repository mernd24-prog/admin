...
export const hasModuleAccess = (moduleCode) => {
  ...
  const moduleAliases = {
    ...
    orders: ["orders", "order", "subscription_orders", "subscription-orders", "view-orders"],
    payments: ["payments", "payment", "payouts"],
    ...
    delivery: ["delivery", "delivery-shipping", "shipping_packages", "shipping-packages", "pickup_addresses", "pickup-addresses", "delivery-staff", "shipping-company-users", "shipment-tracking", "shipping-duration"],
    ...
    "sellers/commissions": ["sellers/commissions", "seller-finance", "seller-commissions", "seller_commissions", "commissions", "seller-payouts", "seller_payouts", "payout-ops-queue", "negative-balances", "settlements"],
    ...
    tax: ["tax", "hsn-code", "hsn-codes", "subtax", "sub-tax", "tax-rule", "tax-documents", "gst"],
