...
>>>>>>> 4cd246e5f8f1ebd76e8adbf0e2ac768c3637a663
...
export const bodyKeys = {
  ...
  updateAllowedModules: ["allowedModules", "modulePermissions"],
...
export const adminApi = {
  listAccessModules: (query) =>
    apiGet(adminEndpoints.accessModules, {
      query,
      allowedQueryKeys: queryKeys.listAccessModules,
    }),
  createAdmin: (body) =>
    apiPost(adminEndpoints.admins, body, {
      allowedBodyKeys: bodyKeys.createAdmin,
    }),
  listAdmins: (query) =>
    apiGet(adminEndpoints.admins, {
      query,
      allowedQueryKeys: queryKeys.listAdmins,
    }),
  createPlatformSubAdmin: (body) =>
    apiPost(adminEndpoints.subAdmins, body, {
      allowedBodyKeys: bodyKeys.createSubAdmin,
    }),
  listPlatformSubAdmins: (query) =>
    apiGet(adminEndpoints.subAdmins, {
      query,
      allowedQueryKeys: queryKeys.listPlatformSubAdmins,
    }),
  updatePlatformSubAdminModules: (userIdOrPayload, body) => {
    const payload = asObjectPayload(userIdOrPayload, body, "userId");
    return apiPatch(
      adminEndpoints.subAdminModules(firstValue(payload, ["userId", "id"])),
      payload,
      {
  ...
  listUsers: (query) =>
    apiGet(adminEndpoints.users, {
      query,
      allowedQueryKeys: queryKeys.listUsers,
    }),
  getUserDetail: (userIdOrPayload) => {
    const payload = asObjectPayload(userIdOrPayload, null, "userId");
    return apiGet(
      adminEndpoints.userById(firstValue(payload, ["userId", "id"]))
    );
  },
  ...
  listVendors: (query) =>
    apiGet(adminEndpoints.vendors, {
      query,
      allowedQueryKeys: queryKeys.listVendors,
    }),
  updateVendorStatus: (sellerIdOrPayload, body) => {
    const payload = asObjectPayload(sellerIdOrPayload, body, "sellerId");
    return apiPatch(
      adminEndpoints.vendorStatus(firstValue(payload, ["sellerId", "id"])),
      payload,
      {
  ...
  productModerationQueue: (query) =>
    apiGet(adminEndpoints.moderationQueue, {
      query,
      allowedQueryKeys: queryKeys.moderationQueue,
    }),
  moderateProduct: (productIdOrPayload, body) => {
    const payload = asObjectPayload(productIdOrPayload, body, "productId");
    return apiPatch(
      adminEndpoints.moderateProduct(firstValue(payload, ["productId", "id"])),
      payload,
      {
  ...
  listOrders: (query) =>
    apiGet(adminEndpoints.orders, {
      query,
      allowedQueryKeys: queryKeys.listOrders,
    }),
  listPayments: (query) =>
    apiGet(adminEndpoints.payments, {
      query,
      allowedQueryKeys: queryKeys.listPayments,
    }),
  createPayout: (body) =>
    apiPost(adminEndpoints.payouts, body, {
      allowedBodyKeys: bodyKeys.createPayout,
    }),
  listPayouts: (query) =>
    apiGet(adminEndpoints.payouts, {
      query,
      allowedQueryKeys: queryKeys.listPayouts,
    }),
  taxReports: (query) =>
    apiGet(adminEndpoints.taxReports, {
      query,
      allowedQueryKeys: queryKeys.taxReport,
    }),
  generateInvoice: (orderIdOrPayload) => {
    const payload = asObjectPayload(orderIdOrPayload, null, "orderId");
    return apiPost(
      adminEndpoints.invoice(firstValue(payload, ["orderId", "id"]))
    );
  },
  createApiKey: (body) =>
    apiPost(adminEndpoints.apiKeys, body, {
      allowedBodyKeys: bodyKeys.createApiKey,
    }),
  listApiKeys: (query) =>
    apiGet(adminEndpoints.apiKeys, {
      query,
      allowedQueryKeys: queryKeys.listApiKeys,
    }),
  createWebhook: (body) =>
    apiPost(adminEndpoints.webhooks, body, {
      allowedBodyKeys: bodyKeys.createWebhook,
    }),
  listWebhooks: (query) =>
    apiGet(adminEndpoints.webhooks, {
      query,
      allowedQueryKeys: queryKeys.listWebhooks,
    }),
  upsertFeatureFlag: (body) =>
    apiPut(adminEndpoints.featureFlags, body, {
      allowedBodyKeys: bodyKeys.upsertFeatureFlag,
    }),
  listFeatureFlags: (query) =>
    apiGet(adminEndpoints.featureFlags, {
      query,
      allowedQueryKeys: queryKeys.listFeatureFlags,
    }),
  realtimeAnalytics: (query) =>
    apiGet(adminEndpoints.realtimeAnalytics, {
      query,
      allowedQueryKeys: queryKeys.realtimeAnalytics,
    }),
  returnsAnalytics: (query) =>
    apiGet(adminEndpoints.returnsAnalytics, {
      query,
      allowedQueryKeys: queryKeys.returnsAnalytics,
    }),
  listChargebacks: (query) =>
    apiGet(adminEndpoints.chargebacks, {
      query,
      allowedQueryKeys: queryKeys.listChargebacks,
    }),
  ...
  listDeadLetterEvents: (query) =>
    apiGet(adminEndpoints.deadLetter, {
      query,
      allowedQueryKeys: queryKeys.listDeadLetter,
    }),
  retryDeadLetterEvent: (eventIdOrPayload, body) => {
    const payload = asObjectPayload(eventIdOrPayload, body, "eventId");
    return apiPost(
      adminEndpoints.retryDeadLetter(firstValue(payload, ["eventId", "id"])),
      payload,
      {
  ...
  discardDeadLetterEvent: (eventIdOrPayload, body) => {
    const payload = asObjectPayload(eventIdOrPayload, body, "eventId");
    return apiPost(
      adminEndpoints.discardDeadLetter(firstValue(payload, ["eventId", "id"])),
      payload,
      {
        allowedBodyKeys: bodyKeys.deadLetterAction,
      }
  ...
  createSubscriptionPlan: (body) =>
    apiPost(adminEndpoints.subscriptionPlans, body, {
      allowedBodyKeys: bodyKeys.createSubscriptionPlan,
    }),
  listSubscriptionPlans: (query) =>
    apiGet(adminEndpoints.subscriptionPlans, {
      query,
      allowedQueryKeys: queryKeys.listSubscriptionPlans,
    }),
  getSubscriptionPlan: (planIdOrPayload) => {
    const payload = asObjectPayload(planIdOrPayload, null, "planId");
    return apiGet(
      adminEndpoints.subscriptionPlanById(firstValue(payload, ["planId", "id"]))
    );
  },
  updateSubscriptionPlan: (planIdOrPayload, body) => {
    const payload = asObjectPayload(planIdOrPayload, body, "planId");
    return apiPatch(
      adminEndpoints.subscriptionPlanById(
        firstValue(payload, ["planId", "id"])
      ),
      payload,
      {
  ...
  updatePlatformSubscriptionStatus: (subscriptionIdOrPayload, body) => {
    const payload = asObjectPayload(
      subscriptionIdOrPayload,
      body,
      "subscriptionId"
    );
    return apiPatch(
      adminEndpoints.platformSubscriptionStatus(
        firstValue(payload, ["subscriptionId", "id"])
      ),
      payload,
      {
  ...
  createPlatformFeeConfig: (body) =>
    apiPost(adminEndpoints.feeConfig, body, {
      allowedBodyKeys: bodyKeys.createPlatformFeeConfig,
    }),
  listPlatformFeeConfigs: (query) =>
    apiGet(adminEndpoints.feeConfig, {
      query,
      allowedQueryKeys: queryKeys.listPlatformFeeConfigs,
    }),
  getPlatformFeeConfig: (configIdOrPayload) => {
    const payload = asObjectPayload(configIdOrPayload, null, "configId");
    return apiGet(
      adminEndpoints.feeConfigById(firstValue(payload, ["configId", "id"]))
    );
  },
  ...
  createCategory: (body) =>
    apiPost(adminEndpoints.categories, body, {
      allowedBodyKeys: bodyKeys.createCategory,
    }),
  listCategories: (query) =>
    apiGet(adminEndpoints.categories, {
      query,
      allowedQueryKeys: queryKeys.listCategories,
    }),
  getCategory: (categoryKeyOrPayload) => {
    const payload = asObjectPayload(categoryKeyOrPayload, null, "categoryKey");
    return apiGet(
      adminEndpoints.categoryByKey(
        firstValue(payload, ["categoryKey", "key", "id"])
      )
    );
  },
  ...
  createProductFamily: (body) =>
    apiPost(adminEndpoints.productFamilies, body, {
      allowedBodyKeys: bodyKeys.createProductFamily,
    }),
  listProductFamilies: (query) =>
    apiGet(adminEndpoints.productFamilies, {
      query,
      allowedQueryKeys: queryKeys.listProductFamilies,
    }),
  getProductFamily: (familyCodeOrPayload) => {
    const payload = asObjectPayload(familyCodeOrPayload, null, "familyCode");
    return apiGet(
      adminEndpoints.productFamilyByCode(
        firstValue(payload, ["familyCode", "code", "id"])
      )
    );
  },
  ...
  createProductVariant: (body) =>
    apiPost(adminEndpoints.productVariants, body, {
      allowedBodyKeys: bodyKeys.createProductVariant,
    }),
  listProductVariants: (query) =>
    apiGet(adminEndpoints.productVariants, {
      query,
      allowedQueryKeys: queryKeys.listProductVariants,
    }),
  getProductVariant: (variantIdOrPayload) => {
    const payload = asObjectPayload(variantIdOrPayload, null, "variantId");
    return apiGet(
      adminEndpoints.productVariantById(
        firstValue(payload, ["variantId", "id"])
      )
    );
  },
  ...
  createHsnCode: (body) =>
    apiPost(adminEndpoints.hsnCodes, body, {
      allowedBodyKeys: bodyKeys.createHsnCode,
    }),
  listHsnCodes: (query) =>
    apiGet(adminEndpoints.hsnCodes, {
      query,
      allowedQueryKeys: queryKeys.listHsnCodes,
    }),
  getHsnCode: (hsnCodeOrPayload) => {
    const payload = asObjectPayload(hsnCodeOrPayload, null, "hsnCode");
    return apiGet(
      adminEndpoints.hsnCodeByCode(
        firstValue(payload, ["hsnCode", "code", "id"])
      )
    );
  },
  ...
  createGeography: (body) =>
    apiPost(adminEndpoints.geography, body, {
      allowedBodyKeys: bodyKeys.createGeography,
    }),
  listGeography: (query) =>
    apiGet(adminEndpoints.geography, {
      query,
      allowedQueryKeys: queryKeys.listGeographies,
    }),
  getGeography: (countryCodeOrPayload) => {
    const payload = asObjectPayload(countryCodeOrPayload, null, "countryCode");
    return apiGet(
      adminEndpoints.geographyByCode(
        firstValue(payload, ["countryCode", "code", "id"])
      )
    );
  },
  ...
  createContentPage: (body) =>
    apiPost(adminEndpoints.contentPages, body, {
      allowedBodyKeys: bodyKeys.createContentPage,
    }),
  listContentPages: (query) =>
    apiGet(adminEndpoints.contentPages, {
      query,
      allowedQueryKeys: queryKeys.listContentPages,
    }),
  getContentPage: (slugOrPayload) => {
    const payload = asObjectPayload(slugOrPayload, null, "slug");
    return apiGet(
      adminEndpoints.contentPageBySlug(firstValue(payload, ["slug", "id"]))
    );
  },
...
export const authApi = {
  register: (body) =>
    apiPost(authEndpoints.register, body, {
      allowedBodyKeys: bodyKeys.register,
    }),
  registerOtp: (body) =>
    apiPost(authEndpoints.registerOtp, body, {
      allowedBodyKeys: bodyKeys.register,
    }),
  ...
  verifyOtp: (body) =>
    apiPost(authEndpoints.verifyOtp, body, {
      allowedBodyKeys: bodyKeys.verifyOtp,
    }),
  resendOtp: (body) =>
    apiPost(authEndpoints.resendOtp, body, {
      allowedBodyKeys: bodyKeys.resendOtp,
    }),
  resetPassword: (body) =>
    apiPost(authEndpoints.resetPassword, body, {
      allowedBodyKeys: bodyKeys.resetPassword,
    }),
  changePassword: (body) =>
...
export const sellerApi = {
  ...
  reviewSellerKyc: (sellerIdOrPayload, body) => {
    const payload = asObjectPayload(sellerIdOrPayload, body, "sellerId");
    return apiPatch(
      sellerEndpoints.reviewKyc(firstValue(payload, ["sellerId", "id"])),
      payload,
      {
  ...
  listSellerTracking: (query) =>
    apiGet(sellerEndpoints.tracking, {
      query,
      allowedQueryKeys: queryKeys.sellerTracking,
    }),
  getSellerTrackingDetail: (orderIdOrPayload) => {
    const payload = asObjectPayload(orderIdOrPayload, null, "orderId");
    return apiGet(
      sellerEndpoints.trackingOrder(firstValue(payload, ["orderId", "id"]))
    );
  },
  getSellerProfile: () => apiGet(sellerEndpoints.profile),
  updateSellerProfile: (body) =>
    apiPatch(sellerEndpoints.profile, body, {
      allowedBodyKeys: bodyKeys.sellerProfile,
    }),
  updateBusinessAddress: (body) =>
    apiPatch(sellerEndpoints.businessAddress, body, {
      allowedBodyKeys: bodyKeys.sellerAddress,
    }),
  updatePickupAddress: (body) =>
    apiPatch(sellerEndpoints.pickupAddress, body, {
      allowedBodyKeys: bodyKeys.sellerAddress,
    }),
  updateBankDetails: (body) =>
    apiPatch(sellerEndpoints.bankDetails, body, {
      allowedBodyKeys: bodyKeys.sellerBank,
    }),
  updateMoreInfo: (body) =>
    apiPatch(sellerEndpoints.moreInfo, body, {
      allowedBodyKeys: bodyKeys.sellerMoreInfo,
    }),
  updateSettings: (body) =>
    apiPatch(sellerEndpoints.settings, body, {
      allowedBodyKeys: bodyKeys.sellerSettings,
    }),
  sellerDashboard: (query) =>
    apiGet(sellerEndpoints.dashboard, {
      query,
      allowedQueryKeys: queryKeys.sellerDashboard,
    }),
  createSellerSubAdmin: (body) =>
    apiPost(sellerEndpoints.subAdmins, body, {
      allowedBodyKeys: bodyKeys.createSubAdmin,
    }),
  ...
  updateSellerSubAdminModules: (userIdOrPayload, body) => {
    const payload = asObjectPayload(userIdOrPayload, body, "userId");
    return apiPatch(
      sellerEndpoints.subAdminModules(firstValue(payload, ["userId", "id"])),
      payload,
      {
        allowedBodyKeys: bodyKeys.updateAllowedModules,
      }
...
export const sellerCommissionApi = {
  ...
  calculateOrderCommission: (orderIdOrPayload) => {
    const payload = asObjectPayload(orderIdOrPayload, null, "orderId");
    return apiPost(
      sellerCommissionEndpoints.calculate(
        firstValue(payload, ["orderId", "id"])
      )
    );
  },
