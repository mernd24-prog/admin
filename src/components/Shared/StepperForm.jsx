          ...
          {steps.map((step, i) => {
            ...
            return (
              <React.Fragment key={i}>
                ...
                >
                  ...
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-200 ${
                        ...
                        : active
                          ? "bg-[var(--admin-navy)] text-white shadow-md ring-4 ring-[var(--admin-blue)]/10"
                  ...
                  >
                    {step.label}
                    {step.optional && (
                      <span className="text-gray-300 ml-0.5">(opt)</span>
                    )}
                  </span>
                </div>
                ...
                {i < steps.length - 1 && (
                  <div
                    className={`flex-1 h-0.5 mx-2 rounded-full transition-colors duration-300 ${i < current ? "bg-green-400" : "bg-[var(--admin-line)]"}`}
                  />
                )}
              </React.Fragment>
            );
