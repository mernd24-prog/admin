    ...
    <div className="space-y-5">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
        ...
        <p className="text-xs text-blue-600 mt-0.5">
          Customers receive a download link or license key after purchase. No
          physical shipping.
        </p>
      </div>
      ...
      <Field
        ...
        hint="Direct link to the file or a signed CDN URL. Customers get this after payment."
      >
        <input
          type="url"
      ...
      {/* Preview URL */}
      <Field
        label="Preview / Sample URL"
        hint="Free sample or preview version (optional)."
      >
        <input
          type="url"
          className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--admin-blue)]"
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Field
          label="File Size (MB)"
          hint="Shown to customers before download."
        >
          <input
            type="number"
            min={0}
      ...
      <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            Customers must be signed in to access the file. Recommended for
            premium content.
          </p>
        </div>
      </div>
