  ...
  return (
    <>
      ...
      >
        ...
        {isButtonView && (
          <div
            className={`sticky bottom-0 left-0 right-0 bg-[var(--admin-surface-soft)] p-3 md:p-4 flex justify-between items-center border-t border-[var(--admin-line)] ${buttonsClassName}`}
          >
            <TransparentButton
              onClick={onClose}
