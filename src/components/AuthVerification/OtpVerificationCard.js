...
const OtpVerificationCard = ({
  ...
  <div className="relative z-10 mx-auto flex w-full max-w-full flex-col items-center justify-center">
    ...
    <div className="mt-[18px] grid w-full max-w-[476px] grid-cols-6 gap-2 min-[420px]:gap-[10px] sm:gap-[14px]">
      {[0, 1, 2, 3, 4, 5].map((index) => (
        <input
          ...
          type="text"
          maxLength={1}
          className="aspect-square w-full rounded-[4px] border border-[#eeeeee] bg-white text-center text-[18px] text-[#9a9a9a] shadow-[0_4px_8px_rgba(0,0,0,0.12)] outline-none transition-all duration-300 focus:border-[#082f91] focus:ring-2 focus:ring-[#dbe3ff] sm:h-[70px] sm:text-[22px]"
