...
const ReturnPolicyList = () => {
  ...
  const handleEditFAQ = async (e) => {
    ...
    try {
      ...
      toast.error(error.message || "Error updating FAQ");
      if (error.errors) {
        setErrors(error.errors);
      }
    }
    ...
    <>
      ...
      <div className='max-w-7xl mx-auto'>
        <div className='overflow-hidden overflow-y-auto py-6'>
          <div className="flex justify-between items-center">
            <h3>
              ...
              <Link to="/app/return-policy" className='ml-1'><b>Return Policy</b></Link> / 
              <b className='ml-1'>Return Policy List</b>
            </h3>
            <AddButton
        ...
        >
          ...
          <div className='flex justify-between items-center border px-3 mt-4'>
            <p className="font-medium text-sm">Status</p>
            <ToggleButton
              isToggle={!formData.isDisable}
              handleClick={handleToggleStatus}
        ...
        <DeletePopup
          ...
          DeleteHeading={'Are you sure you want to delete this Policy?'}
        />
        ...
        <StatusPopup
          ...
          heading={`Are you sure you want to ${toggleStates?.isDisable ? 'enable' : 'disable'} this Policy?`}
        />
      </div>
    </>
  )
