...
const BannerSetup = ({ onClose, isOpen }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Submitted Data:', formData, 'Image:', imagePreview);
    // Add backend submit logic here
  };
    ...
    >
      <div className="w-11/12 max-w-xl p-6 bg-white rounded-lg shadow-xl overflow-y-auto max-h-[95vh]">
        <div className="flex items-center justify-between pb-3 border-b">
          <h2 className="text-xl font-semibold">Banner Setup</h2>
