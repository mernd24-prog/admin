    ...
    <>
      ...
      <div className='max-w-7xl mx-auto'>
        <div className='overflow-hidden overflow-y-auto py-6'>
          <div className="flex justify-between items-center">
            <h3>
              ...
              <Link to="/app/terms-and-conditions" className='ml-1'><b>Terms & Conditions</b></Link> /
              <b className='ml-1'>Terms & Conditions List</b>
            </h3>
            <AddButton
        ...
        <DeletePopup
          ...
          DeleteHeading={'Are you sure you want to delete the Terms & Conditions?'}
        />
