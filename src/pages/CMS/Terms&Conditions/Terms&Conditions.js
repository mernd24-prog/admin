...
const TermsConditions = () => {
    ...
    useEffect(() => {
        const reqData = {
            ...
            query: JSON.stringify({ type: "terms-and-conditions" })
        };
    ...
    const tableRows = getListData?.map((user) => [
        ...
        <span key={`actions-${user._id}`}>
            <ActionButtons
                ...
                onListing={() => {
                    navigate(`/app/terms-and-conditions/${user._id}`);
                }}
            ...
            <div className='max-w-7xl mx-auto'>
                <div className='overflow-hidden overflow-y-auto py-6'>
                    <div className="flex justify-between items-center">
                        <h3><Link to="/app/home">Home</Link> / <b>Terms & Conditions</b></h3>
                        <AddButton
                ...
                >
                    ...
                    <div className="px-4 pt-2">
                        <TextEditor
                            ...
                            onChange={(value) => { setForm((prev) => ({ ...prev, content: value })); setErrors({}) }}
