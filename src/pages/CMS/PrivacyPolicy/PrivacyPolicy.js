...
import {  roleBasedAccess2, roles } from '../../../_helpers/globalFunctions';
import FilterSelect from '../../../components/Atoms/FilterSelect/FilterSelect';
import { TextEditor } from '../../../components/Atoms/FormInput/TextEditor';
const PrivacyPolicyCategory = () => {
    ...
    useEffect(() => {
        const reqData = {
            ...
            query: JSON.stringify({ type: "privacy-policies" })
        };
    ...
    const handleEditUserSubmit = (e) => {
        ...
        dispatch(updateCMSCategory(reqData))
            ...
            .catch((error) => {
                ...
                toast.error(error || "Error in updating Privacy Policy ");
            });
    };
    ...
    const confirmDelete = () => {
        dispatch(deleteCategory(deleteData))
            ...
            .then((res) => {
                ...
                toast.success(res.message || "Privacy Policy  deleted successfully");
                setShowDeleteConfirmation(false);
                setIsRefresh(!isRefresh);
            })
            .catch((error) => {
                console.error("Error deleting Privacy Policy :", error);
                toast.error(error || "Error in deleting Privacy Policy ");
            });
    };
            ...
            <div className='max-w-7xl mx-auto'>
                <div className='overflow-hidden overflow-y-auto py-6'>
                    <div className="flex justify-between items-center">
                        <h3><Link to="/app/home">Home</Link> / <b>Privacy Policy</b></h3>
                        <AddButton
                    ...
                    <div className='overflow-y-auto bg-white rounded-lg border border-[#E6E6E6]'>
                        ...
                        <TableData
                            ...
                            tableHeadings={[
                                "Category Name", "User", "Status", "Actions"]}
                            data={tableRows}
                            showSearch={true}
