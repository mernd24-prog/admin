    ...
    <>
      ...
      <div className='max-w-7xl mx-auto'>
        <div className='overflow-hidden overflow-y-auto py-6'>
          <div className="flex justify-between items-center">
            <h3>
              ...
              <Link to="/app/faqs" className='ml-1'><b>FAQs</b></Link> / 
              <b className='ml-1'>FAQList</b>
            </h3>
            <AddButton
        ...
        <DeletePopup
          ...
          DeleteHeading={'Are you sure you want to delete the FAQ?'}
        />
        ...
        <StatusPopup
          ...
          heading={`Are you sure you want to ${toggleStates?.isDisable ? 'enable' : 'disable'} this FAQ?`}
        />
      </div>
    </>
  )
