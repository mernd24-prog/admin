...
const FAQ = () => {
    ...
    useEffect(() => {
        const reqData = {
            ...
            query: JSON.stringify({ type: "faqs" })
        };
    ...
    const tableRows = getListData?.map((user) => [
        ...
        <span key={`actions-${user._id}`}>
            <ActionButtons
                ...
                onListing={() => {
                    navigate(`/app/faqsList/${user._id}`);
                }}
            ...
            <div className='max-w-7xl mx-auto'>
                <div className='overflow-hidden overflow-y-auto py-6'>
                    <div className="flex justify-between items-center">
                        <h3><Link to="/app/home">Home</Link> / <b>FAQs</b></h3>
                        <AddButton
                ...
                >
                    ...
                    <div className='flex justify-between items-center border p-2 mt-4'>
                ...
                <DeletePopup
                    ...
                    DeleteHeading={'Are you sure you want to delete this FAQ category?'}
                />
                ...
                <StatusPopup
                    ...
                    heading={`Are you sure you want to ${toggleStates?.isDisable ? 'enable' : 'disable'} this FAQ category?`}
                />
            </div>
        </>
    );
