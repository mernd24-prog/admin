...
const PaymentPolicy = () => {
    ...
    useEffect(() => {
        const reqData = {
            ...
            query: JSON.stringify({ type: "payment-policies" })
        };
    ...
    const tableRows = getListData?.map((user) => [
        ...
        <span key={`actions-${user._id}`}>
            <ActionButtons
                ...
                onListing={() => {
                    navigate(`/app/payment-policy-list/${user._id}`);
                }}
            ...
            <div className='max-w-7xl mx-auto'>
                <div className='overflow-hidden overflow-y-auto py-6'>
                    <div className="flex justify-between items-center">
                        <h3><Link to="/app/home">Home</Link> / <b>Payment Policy</b></h3>
                        <AddButton
