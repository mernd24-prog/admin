        ...
        <div className='p-3 max-w-7xl mx-auto space-y-3'>
            ...
            <div className='bg-white'>
                <div className='p-2 border-b'>
                    <SearchComponent filters={filters} setFilters={setFilters} isActionButton={true} isStatusAction={true} />
                </div>
            ...
            <DefaultModal
                title={modalState.type === "Add" ? "Add Tax Category" : "Edit Tax Category"}
                ...
                <div className='p-3 space-y-4'>
                    ...
                    <div className='  rounded space-y-4'>
                        <div className='flex justify-between items-center border p-3 hover:border-blue-400'>
                            ...
                            <ToggleButton isToggle={inputData.isDisable} handleClick={handleToggle} />
                        </div>
