...
function TaxStructure() {
  ...
  useEffect(() => {
    if (modalState.data) {
      setInputData({
        ...
        components: modalState.data.components.length > 0
  ...
  const handleSubmit = () => {
    ...
    const taxStructureData = {
      ...
      components: inputData.isCombined ? inputData.components.filter(c => c.trim()) : []
    };

    if (modalState.type === "Add") {
      setTaxStructures([...taxStructures, taxStructureData]);
    } else {
      setTaxStructures(taxStructures.map(item =>
  ...
  return (
    <div className='p-3 max-w-7xl mx-auto space-y-3'>
      ...
      <div className='bg-white'>
        ...
        <div>
          <TableData
            tableHeadings={['Tax Structure Name', 'Combined Tax Structure?', 'Action']}
      ...
      <DefaultModal
        title={modalState.type === "Add" ? "Add Tax Structure" : "Edit Tax Structure"}
        ...
        <div className='p-3 space-y-4'>
          ...
          <div className='  rounded space-y-4'>
            <div className='flex justify-between items-center border p-3'>
              ...
              <ToggleButton isToggle={inputData.isCombined} handleClick={handleToggle}/>
              {/* <input type='checkbox'
            ...
            {inputData.isCombined && (
              <div className="space-y-3">
                ...
                {inputData.components.map((component, index) => (
                  <div key={index} className="grid grid-cols-3 items-center space-x-2">
