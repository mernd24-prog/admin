    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
        ...
        <p className="text-sm text-gray-500 max-w-md mx-auto">
          The Collections feature allows you to create curated product groups
          (e.g. "Summer Sale", "New Arrivals") that appear as sections on the
          storefront. Backend integration is in progress.
        </p>
        <div className="mt-6 inline-flex items-center gap-2 text-xs text-blue-600 bg-blue-50 px-4 py-2 rounded-lg">
          <span>
            Backend API:{" "}
            <code className="font-mono">/admin/platform/collections</code>
          </span>
        </div>
      </div>
    </div>
